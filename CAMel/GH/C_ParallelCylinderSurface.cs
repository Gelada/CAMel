namespace CAMel.GH
{
    ...
    [UsedImplicitly]
    public class C_ParallelCylinderPath : GH_Component
    {
        /// <inheritdoc />
        /// <summary>
        ...
        public C_ParallelCylinderPath()
            : base(
                "Create Parallel Cylinder Surfacing Path", "ParCylPath",
                "Create a surfacing recipe going up and down round a cylinder",
                "CAMel", " ToolPaths") { }
        ...
        protected override void RegisterInputParams([NotNull] GH_InputParamManager pManager)
        {
            ...
            pManager.AddPlaneParameter("Direction", "Dir", "Plane to use, Up and down paths parallel to Z.", GH_ParamAccess.item, Plane.WorldXY);
        ...
        protected override void SolveInstance([NotNull] IGH_DataAccess da)
        {
            ...
            {
                this.AddRuntimeMessage(GH_RuntimeMessageLevel.Error, "Input parameter TD can only have integer values 0 to 4");
                return;
            }
            ...
            for (int i = 0; i < split; i++)
            {
                ...
                SurfacePath sP = Surfacing.parallelCylinder(c, dir, stepOver, sTD, uBb, mT);
