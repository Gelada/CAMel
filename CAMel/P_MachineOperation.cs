...
namespace CAMel.Types
{
    ...
    public class MachineOperation : ToolPointContainer
    {
        ...
        public void WriteCode(ref CodeInfo Co, Machine M, out ToolPath eP, ToolPath sP = null)
        {
            ...
            Co.AppendLine(M.CommentChar.ToString());
            Co.AppendLine(M.CommentChar + " Operation: " + this.name);
            Co.AppendLine(M.CommentChar.ToString());
            ...
            foreach (ToolPath TP in this.TPs)
            {
                if (oldPath != null)
                {
                    ...
                    if (inMaterial && first)
                    {
                        ...
                        Co.AppendLine(M.CommentChar + " Transition between operations might be in material.");
                    }
                    else if (inMaterial && Length > M.PathJump)
                    {
                        ...
                        Co.AppendLine(M.CommentChar + " Long Transition between paths in material.");
                    }
